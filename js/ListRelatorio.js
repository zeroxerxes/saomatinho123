function efetuarFiltroPorAno() {
    window.location = "ListRelatorio.aspx?idCanal=" + getIdCanal() + "&ano=" + $('select[id$=ddlAnoFiltro] option:selected').val();
}

function limpaFiltroPorAno() {
    window.location = "ListRelatorio.aspx?idCanal=" + getIdCanal();
}
...
$(document).ready(function () { 
    ...
    $('a[id*=linkListaTituloChamada]').each(function () {
        ...
        $(this).parent().parent().find('a#linkDownload').attr('href', link);
    });
